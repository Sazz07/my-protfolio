...
const categories = ["All", "Web Application", "E-Commerce", "Dashboard", "Productivity", "Portfolio"]
        ...
        <div className="mb-12">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground">
              A collection of my work showcasing my skills in web development, from frontend interfaces to full-stack
              applications.
            </p>
          </div>
        </div>
